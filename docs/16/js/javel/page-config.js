...
//        const confs = [];
    ...
    #setCss() {
        ...
        s('--column-width', this._.pageOfColumn.column.width + 'px');
        //s('--column-count', this._.pageOfColumn.column.count);
        s('--column-count', 'auto'); // column-width で 処理する（this._.pageOfColumn.column.count）
    ...
    #getLineHeight() {
        ...
        console.log(this._.pageOfColumn.size.block, thresholds);
